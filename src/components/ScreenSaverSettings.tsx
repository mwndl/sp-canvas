      ...
      {config.movement === 'fade' && (
        <div className="flex items-center justify-between p-4 bg-gray-750/30">
          <div className="flex-1">
            <h3 className="text-white font-medium">Velocidade de Fade</h3>
            <p className="text-gray-400 text-sm">Tempo para fade out/in em segundos</p>
          </div>
          <input
            type="number"
            value={config.fadeSpeed}
            onChange={(e) => updateConfig({ fadeSpeed: parseFloat(e.target.value) || 2 })}
            min="0.5"
            max="10"
            step="0.5"
